...
import androidx.annotation.Nullable;  // Importe a classe @Nullable
            ...
            Glide.with(verPassageiro.this)
                    ...
                    .listener(new RequestListener<Drawable>() {
                        ...
                        public boolean onLoadFailed(@Nullable GlideException e, Object model,
                            ...
                            // Pode adicionar um log ou algo aqui
                            return false;
                        }
                        ...
                        public boolean onResourceReady(Drawable resource, Object model,
                            ...
                            carregandoFoto.setVisibility(View.GONE);  // Corrigi a variável de carregamento
                            return false;
                        }
                    }).into(img);
        } else {
